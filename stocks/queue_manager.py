...
def _handle_review_task(ticker: str, trigger_reason: str):
    ...
    new_version = ThesisVersion(
        ...
        upper_alert_threshold=safe_float(meta.get("upper_alert_threshold") or meta.get("new_upper_alert_threshold"), current_price * 1.15),
        lower_alert_threshold=safe_float(meta.get("lower_alert_threshold") or meta.get("new_lower_alert_threshold"), current_price * 0.88),
